...
<div class="address-container">
    ...
    <form action="{{ route('purchase.address.update', $item->id) }}" method="post" class="address-form">
        ...
        <div class="address-form__group">
            ...
            <input type="text" name="postcode" id="postcode" class="address-form__input" value="{{ old('postcode', $profile->postcode ?? '') }}">
            @error('postcode')
        ...
        <div class="address-form__group">
            ...
            <input type="text" name="address" id="address" class="address-form__input" value="{{ old('address', $profile->address ?? '') }}">
            @error('address')
            <p class="address-form__error">{{ $message }}</p>
            @enderror
        </div>
        <div class="address-form__group">
            ...
            <input type="text" name="building" id="building" class="address-form__input" value="{{ old('building', $profile->building ?? '') }}">
            @error('building')
            <p class="address-form__error">{{ $message }}</p>
            @enderror
        </div>
